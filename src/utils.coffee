class SNAKE.Utils
    ...
    # Returns an ID classifying a datum by strict equality to any other datum. 
    # The datum can be an object or primitive. E.g. passing in the integer 1
    # will always return an ID x, while passing in an object {} will return
    # IDs xi, xi+1, xi+2, ... since object equality is based on memory address
    # while primitive equality is based on evaluation.
    @equivalenceId: do ->
